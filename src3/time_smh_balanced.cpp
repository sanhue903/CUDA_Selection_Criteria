...
//	int n_bands = 1;
	...
	while ((c = getopt(argc, argv, "xu:l:L:t:h:m:")) != -1)
	{
		switch (c) {
			case 'x':
				std::cout << "-u -l -L -t -h -m\n";
				return 0;
			break;
			case 'u':
	...
	std::cout << "Balanced" << ";build_smh;" << threshold << ";";
	...
	// CRITERIO SMHa
	std::cout << "Balanced" << ";smh_a;" << threshold << ";";
	...
	// CRITERIO CB+SMHa
	std::cout << "Balanced" << ";CB+smh_a;" << threshold << ";";
